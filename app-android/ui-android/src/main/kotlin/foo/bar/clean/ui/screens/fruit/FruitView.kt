    ...
    StateWrapperView(
        ...
        ViewTemplate(horizontalAlignment = Alignment.Start) {
            Fruit(
                fruitState = fruitState,
                size = size,
                fetchFruit = { perform(foo.bar.clean.ui.actionhandlers.Act.ScreenFruit.Fetch) },
                fetchFruitForceFail = { perform(foo.bar.clean.ui.actionhandlers.Act.ScreenFruit.FetchSimulateFail) },
            )
        }
    }
}
